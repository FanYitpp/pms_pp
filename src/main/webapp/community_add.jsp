	...
	$(document).ready(function() {
		...
		$("#submitbutton").click(function() {
			if(validateForm()){
				/*$("#submitForm").submit();*/
				$.ajax({
	                    data: {"communityName": $("#commName").val(), "communityBuildingingnum": $("#commBuildingingnum").val(), "communityAddress": $("#commAddress").val(), "communityManager": $("#commManager").val(), "communityManagerLink":$("#commManagerLink").val(), "communityArea":$("#commArea").val(), "communityCreatetime": $("#commCreatetime").val()},
	                    type: "POST",
	                    url: "<%=basePath %>insertcomm.action",
...
<form id="submitForm" name="submitForm" action="<%=basePath %>insertcomm.action" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：基础数据&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增社区</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="commName" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">房屋数</td>
					<td class="ui_text_lt">
						<input type="text" id="commBuildingingnum" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">地址</td>
					<td class="ui_text_lt">
						<input type="text" id="commAddress" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">负责人</td>
					<td class="ui_text_lt">
						<input type="text" id="commManager" class="ui_input_txt02" onkeyup="checkFyFh();"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">负责人联系方式</td>
					<td class="ui_text_lt">
						<input type="text" id="commManagerLink" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">占地面积</td>
					<td class="ui_text_lt">
						<input type="text" id="commArea" class="ui_input_txt02"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="commCreatetime" class="ui_input_txt02"/>
					</td>
				</tr>
