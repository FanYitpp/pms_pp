	...
	$(document).ready(function() {
		...
		$("#submitbutton").click(function() {
			if(validateForm()){
				/*$("#submitForm").submit();*/
				$.ajax({
	                    data: {"houseUnitId":sessionStorage.getItem('unitid'),
		                    ...
		                    "houseBalance":0, 
		                    "houseHostIdName": $("#houseHostIdName").val()
		                    },
	                    type: "POST",
	                    url: "<%=basePath %>inserthouse.action",
...
<form id="submitForm" name="submitForm" method="post">
	<div id="container">
		<div id="nav_links">
			当前位置：基础数据&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增房间</span>
			<div id="page_close">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					<td class="ui_text_rt">户主</td>
					<td class="ui_text_lt">
						<input type="text" id="houseHostIdName" class="ui_input_txt02"/>
					</td>
				</tr>
					...
					<td class="ui_text_lt">
						<select id="houseStyleId">
						  <c:forEach items="${ALstyle }" var="style">
					  		<option value="${style.styleId }">${style.styleName }-${style.styleArea }㎡</option>
						  </c:forEach>
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="houseCreatetime" class="ui_input_txt02"/>
					</td>
				</tr>
