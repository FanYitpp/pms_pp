...
<body>
	<div id="container">
		...
		<img width="45%" style="margin-bottom: -5px;" src="images/common/welcome1.jpg">
		<img width="55%" style="float: right;position: absolute;bottom: 0px;"  src="images/common/welcome.jpg"> 
		</div>
	</div>
	<div style="padding:6px; position: fixed;bottom: 0px;right: 0px;">
		&copy;  2019 河科大实训517教室①组 物业管理系统
	</div>
</body>
</html>
